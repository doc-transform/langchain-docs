---
title: "OpenAIEmbeddings 嵌入集成"
description: "使用 LangChain JavaScript 集成 OpenAIEmbeddings 嵌入模型。"
---

本文将帮助你开始使用 OpenAIEmbeddings [嵌入模型](/oss/integrations/text_embedding)。`OpenAIEmbeddings` 所有功能和配置选项的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/langchain_openai.OpenAIEmbeddings.html)。
...
要访问 OpenAI 嵌入模型，你需要创建 OpenAI 账户、获取 API 密钥，并安装 `@langchain/openai` 集成包。
