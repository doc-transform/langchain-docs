---
title: "MistralAIEmbeddings 嵌入集成"
description: "使用 LangChain JavaScript 集成 MistralAIEmbeddings 嵌入模型。"
---

本文将帮助你开始使用 MistralAIEmbeddings [嵌入模型](/oss/integrations/text_embedding)。`MistralAIEmbeddings` 所有功能和配置选项的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/langchain_mistralai.MistralAIEmbeddings.html)。
...
要访问 MistralAI 嵌入模型，你需要创建 MistralAI 账户、获取 API 密钥，并安装 `@langchain/mistralai` 集成包。
...
所有 MistralAIEmbeddings 功能和配置的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/langchain_mistralai.MistralAIEmbeddings.html)。
