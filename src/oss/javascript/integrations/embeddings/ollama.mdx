---
title: "OllamaEmbeddings 嵌入集成"
description: "使用 LangChain JavaScript 集成 OllamaEmbeddings 嵌入模型。"
---

本文将帮助你开始使用 OllamaEmbeddings [嵌入模型](/oss/integrations/text_embedding)。`OllamaEmbeddings` 所有功能和配置选项的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/langchain_ollama.OllamaEmbeddings.html)。
