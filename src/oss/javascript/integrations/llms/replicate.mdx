---
title: "Replicate 集成"
description: "使用 LangChain JavaScript 集成 Replicate LLM 模型。"
---

以下是将 Replicate 模型作为 LLM 调用的示例：
...
你可以通过更改 `model` 参数来通过 Replicate 运行其他模型。

你可以在 [Replicate 官网](https://replicate.com/explore)找到可用模型的完整列表。
