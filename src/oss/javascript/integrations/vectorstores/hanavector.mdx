---
title: "SAP HANA Cloud Vector Engine 集成"
description: "使用 LangChain JavaScript 集成 SAP HANA Cloud Vector Engine 向量存储。"
---

[SAP HANA Cloud Vector Engine](https://www.sap.com/events/teched/news-guide/ai.html#article8) 是一个完全集成到 `SAP HANA Cloud 数据库`的向量存储。
...
有关在数据库级别创建索引的更多信息，例如参数要求，请参考[官方文档](https://help.sap.com/docs/hana-cloud-database/sap-hana-cloud-sap-hana-database-vector-engine-guide/create-vector-index-statement-data-definition)。
