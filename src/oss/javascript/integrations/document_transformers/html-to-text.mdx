...
description: "使用 LangChain JavaScript 集成 Html-to-text 文档转换器。"
---

在接入 HTML 文档以便后续检索时，我们通常只关心网页的实际内容而非语义标记。
使用 HtmlToTextTransformer 剥离 HTML 标签可以得到内容更丰富的文本块，从而使检索更加有效。
...
你可以向转换器传递 [`html-to-text` 包接受的任何参数](https://www.npmjs.com/package/html-to-text)来自定义其工作方式。
