...
description: "使用 LangChain JavaScript 集成 PromptLayerChatOpenAI 对话模型。"
---

你可以传入可选的 `returnPromptLayerId` 布尔值参数来获取 `promptLayerRequestId`，如下所示。以下是获取 PromptLayerChatOpenAI requestID 的示例：
