...
description: "使用 LangChain JavaScript 集成 ChatPerplexity 对话模型。"
---

本指南将帮助你开始使用 Perplexity [对话模型](/oss/langchain/models)。所有 `ChatPerplexity` 功能和配置的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/_langchain_community.chat_models_perplexity.ChatPerplexity.html)。
...
请注意，截至撰写本文时，Perplexity 仅在某些使用层级上支持结构化输出。
...
所有 ChatPerplexity 功能和配置的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/_langchain_community.chat_models_perplexity.ChatPerplexity.html)。
