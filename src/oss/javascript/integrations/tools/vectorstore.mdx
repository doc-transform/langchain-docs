...
本文将帮助你开始使用 [VectorStoreToolkit](/oss/langchain/tools#toolkits)。所有 VectorStoreToolkit 功能和配置的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/langchain.agents.VectorStoreToolkit.html)。

`VectorStoreToolkit` 是一个工具包，它接受一个向量存储，并将其转换为可调用、传递给 LLM、代理等的工具。
...
所有 VectorStoreToolkit 功能和配置的详细文档请参见 [API 参考](https://api.js.langchain.com/classes/langchain.agents.VectorStoreToolkit.html)。
